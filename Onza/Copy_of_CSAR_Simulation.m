...
filename = "Experiment5_1_5_radius.gif" 
...
ncr = 2 % number of cross range samples (slow time track)  
...
title(['Backprojection Reconstruction ',num2str(ftres),'x',num2str(stres),' Resolution @ H =' num2str(zd(zd_index)), ' meters'])
drawnow
% gif creation 
getframe(h);
frame = getframe(h); 
